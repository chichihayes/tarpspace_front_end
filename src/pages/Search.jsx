                  ...
                  <div key={i} className="result-card match-card">
                    <div className="card-header">
                      <div className="agent-info">
                        <span className="agent-name-result">{agents[r.id]?.name || 'Unknown'}</span>
                        <span className="agent-category-result">{agents[r.id]?.category}</span>
                      </div>
